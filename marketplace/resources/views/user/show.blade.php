        ...
        <section class="row justify-content-evenly">
            <article class="col-3">
                <div>
                    ...
                    <img src="{{asset($user->role=='human'?'images/user-icon.png':'images/store-icon.png')}}"
                                ...
                                <div class="p-1">
                                    <x-comment-color rating="{{$comment->rating}}" class="h-100 w-100 p-1">
                                        ...
                                        <div class="d-flex w-100">
                                            <span>To:</span>
                                            <a href="/{{'products/'.$comment->product->slug}}"
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapse{{$category->id}}" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <a href="/{{$category->slug}}/products?user={{$user->id}}">View all
